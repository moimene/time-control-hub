...
serve(async (req) => {
  ...
  try {
    ...
    // 🛡️ SENTINEL: Verify Authentication
    // Check if the request is authenticated (either Service Role or valid User)
    ...
    // If not Service Role (internal call), verify User JWT
