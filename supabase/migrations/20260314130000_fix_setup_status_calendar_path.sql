-- Migration: fix_setup_status_calendar_path
-- Purpose: Correct the calendar_published check path from /admin/settings
--          to /admin/calendar-laboral where the Publicar button actually lives.
