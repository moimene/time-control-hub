...
export function ClockingDevicesSection() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold">Dispositivos de Fichaje</h2>
          <p className="text-sm text-muted-foreground">Gestiona terminales y dispositivos kiosco</p>
        </div>
